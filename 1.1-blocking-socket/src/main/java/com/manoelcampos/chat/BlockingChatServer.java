...
//                    System.out.print("Digite seu nome de usuário:");
                ...
                if(matchFound == true){
                    sendPrivateMsg(clientSocket, msg, matcher.group(2));
                }else{
    ...
    private void sendPrivateMsg(final ClientSocket sender, final String msg, final String matcher) {
        final Iterator<ClientSocket> iterator = clientSocketList.iterator();
        int count = 0;
